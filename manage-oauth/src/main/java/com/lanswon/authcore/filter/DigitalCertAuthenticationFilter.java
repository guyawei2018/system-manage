 ...
 */
public class DigitalCertAuthenticationFilter extends AbstractAuthenticationProcessingFilter {

    // ~ Static fields/initializers
    // =====================================================================================

    public static final String SPRING_SECURITY_FORM_ID_KEY = "idCard";
    ...
    public DigitalCertAuthenticationFilter() {
        super(new AntPathRequestMatcher(SecurityConstants.DEFAULT_LOGIN_PROCESSING_URL_CERT, "POST"));
    }
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        DigitalCertToken authRequest = new DigitalCertToken(username);
